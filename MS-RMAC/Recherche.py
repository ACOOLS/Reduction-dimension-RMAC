...
#classifier_list = ["MobileNet","Xception","ResNet50","VGG16"]
...
def search (sortie,img_indexes,features,result_path,classifier,type):
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--type', type=str,default='marque',
        help='type de recherche par marque ou modèle  '
    )
    ...
    for id_classifier in range(0,len(classifier_list)):
        ...
        for i_list in range(0,len(sortie_list)) :
            ...
            for img_indexes in img_class:
                search(sortie, img_indexes,features,features_path,classifier,type)
